...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:hue_1  = '00bec0' " cyan
    let s:hue_2  = 'a800ff' " purple
    let s:hue_3  = '0000cd' " blue
    let s:hue_4  = '00aa00' " green

    let s:hue_5   = 'ff0000' " red 1
    let s:hue_5_2 = 'ca1243' " red 2

    let s:hue_6   = 'ff299f' " orange 1
    let s:hue_6_2 = 'fd9801' " orange 2

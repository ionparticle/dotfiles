...
# enable timestamp storage in history, also configure what format to show it in
# execute 'history|tail' to see it in action
HISTTIMEFORMAT='%F %T '

# commands that will not be stored in history
HISTIGNORE=ls:ll:pwd:exit:clear:bg:fg
